...
export function FeaturedCard({ article }: FeaturedCardProps) {
  return (
    <article className="news-card glass-card relative overflow-hidden stagger-1">
      ...
      <div className="p-9 sm:p-12 space-y-7">
        ...
        <div className="flex items-center justify-between gap-3 flex-wrap">
          ...
          <div className="flex items-center gap-2 px-4 py-2 glass-card">
            ...
            <span className="text-[12px] font-semibold tracking-[0.16em] uppercase text-muted-foreground">
              Top Story
            </span>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between pt-6 border-t-2 border-border/40 flex-wrap gap-4">
          ...
          <div className="flex items-center gap-3 text-[14px] text-muted-foreground">
            ...
            <a
              ...
              className="flex items-center gap-2 ml-1 px-5 py-2.5 glass-card text-[13px] font-semibold text-foreground hover:opacity-75 active:scale-95 transition-all duration-150"
            >
              Full Story
